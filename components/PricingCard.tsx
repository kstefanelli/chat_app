...
const tiers = [
  {
    ...
    href: '#',
    priceMonthly: null,
    description: 'Get chatting right away with anyone, anywhere, any language.',
    features: [
        ...
        {tiers.map((tier) => (
          ...
          >
            <div>
              ...
              <p className="text-start mt-6 text-base leading-7 text-gray-600">
                {tier.description}
              </p>
              <ul
                role="list"
                className="mt-10 space-y-4 text-xs md:text-sm leading-6 text-gray-600"
              >
